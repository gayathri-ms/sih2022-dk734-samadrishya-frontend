...
const Signup = () => {
  ...
  const onHandleSubmit = (e) => {
    ...
    if (
      ...
      fetch(
        `https://emailvalidation.abstractapi.com/v1/?api_key=d09d9c9c889446c5830eb0676a4eb0b7&email=${values.email}`
      )
  ...
  return (
    <div>
      <div
        className="fixed z-99 -mt-10 inset-0 overflow-y-auto"
      ...
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <div
            className="fixed inset-0 bg-[url('../public/BG_image.jpg')] bgopacity transition-opacity"
            aria-hidden="true"
          ></div>
